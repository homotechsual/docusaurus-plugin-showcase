...
* Added an ambient module declaration for `@theme/ShowcaseCard` in package source declarations so TypeScript builds can resolve the theme alias used by `ShowcasePage`.
* Fixes CI build failure: `Cannot find module '@theme/ShowcaseCard' or its corresponding type declarations.`
...
[1.2.2]: https://github.com/homotechsual/docusaurus-plugin-showcase/compare/v1.2.1...v1.2.2
