// Docusaurus SVG mark — Apache 2.0 — https://github.com/facebook/docusaurus
type IconProps = { className?: string; size?: number }

export default function DocusaurusIcon({ className, size = 24 }: IconProps) {
  return (
    <svg
    ...
    >
      ...
      {/* inlined <use href="#h" x="60"> — back knee joints */}
      <g fill="#44D860" transform="translate(60, 0)">
      ...
      {/* inlined <use href="#f" x="50"> — back feet */}
      <g fill="#44D860" transform="translate(50, 0)">
      ...
      <path d="M83 123h40v-20H83zm0 60h40v-40H83z" fill="#3ECC5F" />
      {/* front knee joints */}
      <g fill="#44D860">
        <circle cx="123" cy="113" r="10" />
        <circle cx="128" cy="104.3" r="2.4" />
